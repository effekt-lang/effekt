...
class VMTests extends munit.FunSuite {
  ...
  val compiling_sequent_calculus: Seq[(File, Option[Summary])] = Seq(
    ...
    examplesDir / "benchmarks" / "compiling_sequent_calculus" / "factorial_accumulator.effekt" -> Some(Summary(
      staticDispatches = 11,
      dynamicDispatches = 0,
      patternMatches = 0,
      branches = 11,
    ...
    examplesDir / "benchmarks" / "compiling_sequent_calculus" / "fib.effekt" -> Some(Summary(
      staticDispatches = 177,
      dynamicDispatches = 0,
      patternMatches = 0,
      branches = 320,
      pushedFrames = 177,
    ...
    examplesDir / "benchmarks" / "compiling_sequent_calculus" / "iterate_increment.effekt" -> Some(Summary(
      staticDispatches = 1001,
      dynamicDispatches = 0,
      patternMatches = 0,
      branches = 1001,
      pushedFrames = 1,
    ...
    examplesDir / "benchmarks" / "compiling_sequent_calculus" / "lookup_tree.effekt" -> Some(Summary(
      staticDispatches = 22,
      dynamicDispatches = 0,
      patternMatches = 11,
      branches = 11,
    ...
    examplesDir / "benchmarks" / "compiling_sequent_calculus" / "match_options.effekt" -> Some(Summary(
      staticDispatches = 11,
      dynamicDispatches = 0,
      patternMatches = 11,
      branches = 11,
...
//    )),
    ...
    examplesDir / "benchmarks" / "compiling_sequent_calculus" / "sum_range.effekt" -> Some(Summary(
      staticDispatches = 22,
      dynamicDispatches = 0,
      patternMatches = 11,
      branches = 11,
