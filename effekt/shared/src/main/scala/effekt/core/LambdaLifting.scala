...
//    ))
//  }.toMap
//  val lifted: mutable.ListBuffer[core.Toplevel] = mutable.ListBuffer.empty
//
...
//    case core.Def(id, BlockLit(tparams, cparams, vparams, bparams, body), rest) =>
//      lifted.append(Toplevel.Def(id,
...
//  }
//
//  override def toplevel(using Variables) = {
//    case d @ core.Toplevel.Def(id, block) =>
...
//      binding(Variables.block(id, block.tpe, block.capt)) {
//        // TODO is this correct????
//        query(block) ++ query(body)
//      }
//
//    case core.Stmt.Let(id, tpe, expr, body) =>
//      query(expr) ++ binding(Variables.value(id, tpe)) { query(body) }
//
