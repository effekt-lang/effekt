...
class LLVM extends Compiler[String] {
  ...
  object steps {
    ...
    // 3. Run Optimizer
    val afterCore = allToCore(Core) andThen Aggregate andThen optimizer.Deadcode andThen core.Show andThen core.Repr andThen core.Mono andThen optimizer.Optimizer
