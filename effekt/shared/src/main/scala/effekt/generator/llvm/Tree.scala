 ...
 */
enum Definition {
  case Function(linkage: Linkage, callingConvention: CallingConvention, returnType: Type, name: String, parameters: List[Parameter], prefix: Option[Operand], basicBlocks: List[BasicBlock])
