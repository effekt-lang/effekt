...
class VM extends Compiler[(Id, symbols.Module, ModuleDecl)] {
  ...
  lazy val Optimized = allToCore(Core) andThen Aggregate andThen Deadcode andThen core.Show andThen core.Mono andThen core.LambdaSets andThen core.optimizer.Optimizer map {
