...
function make_context(obj, fieldName){
    return {data: obj, holePointer:{obj: obj, fieldName: fieldName}}
}

function apply_context(context,value){
...
function compose_context(context1,context2){
...
function create_context(data, holePointer){
