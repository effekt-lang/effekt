...
declare i64 @openFile(%Pos, %Pos, %Neg, %Neg)
declare void @closeFile(%Pos)
declare void @readFile([2 x i64], [2 x i64], i64, [2 x i64], [2 x i64])
declare void @writeFile(%Pos, %Pos, i64, %Neg, %Neg)
declare %Pos @showFiledescriptor(%Pos)
