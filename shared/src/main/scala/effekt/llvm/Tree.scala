...
case class Inject(id: ValueSymbol, typ: machine.Variant, variant: Int) extends Instruction
...
case class Switch(arg: machine.Value, labels: List[BlockSymbol]) extends Terminator
